...
CREATE INDEX payment_reconciliation_jobs_due_idx
  ON payment_reconciliation_jobs (available_at, created_at)
  WHERE status IN ('PENDING', 'RETRY_SCHEDULED');

CREATE INDEX payment_reconciliation_jobs_stale_idx
  ON payment_reconciliation_jobs (locked_at)
